...
/*
 * init the supplementable page table, which is hash table
 */
void 
...
/*
 *  Retrieve the supplemental page entry in supplemtal page
 *  table, with user virtual address.  
 */
...
bool
load_swap (struct sup_page_entry *spte)
{
...
/*
 * this is to check whether the given spte's page is loaded or not
 */
bool
load_page (struct sup_page_entry *spte)
{
    bool success = false;
    spte->pinned = true;
    if (spte->is_loaded)
